...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/users/**","/list-users/**","/create-users/**",
                ...
                "/etudiant/**", "/login/**", "/register/**","/tasks/**","/delete-user/{username}/**","/list-etudiant/**",
        ...
        http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/delete-user/{username}/**","/grade/delete/{gradeId}/**").hasAuthority("SUPER_ADMIN");
